...
# программа остается простой и понятной, но слишком много деталей
# за которыми теряется смысл. надо вынести все в функции
# просто и тупо - придумал имена и распихал те же строки кода 
# по функциям.
